...
@section('title')
    <title>Thêm mới bài học</title>
@endsection
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Thêm mới bài học</h4>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{ route('admin.lesson.create') }}" enctype="multipart/form-data">
                        @csrf
