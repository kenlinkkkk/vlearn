...
!function (j) {
    ...
    var Pe, Le, Ve, Ie, Fe = L(1), Ue = V(["textarea", "input"]), je = L(3), qe = L(8), $e = L(9), We = L(11),
        ...
        pt = Je(function (e, t) {
            var n = gt.browsers(), r = gt.oses(), o = lt(n, e).fold(rt.unknown, rt.nu),
            ...
            return {
                browser: o, os: i, deviceType: function (e, t, n, r) {
                    var o = e.isiOS() && !0 === /ipad/i.test(n), i = e.isiOS() && !o, a = e.isiOS() || e.isAndroid(),
                        u = a || r("(pointer:coarse)"), s = o || !i && a && r("(min-device-width:768px)"),
                        c = i || a && !s, l = t.isSafari() && e.isiOS() && !1 === /safari/i.test(n), f = !c && !s && !l;
                    return {
                        isiPad: $(o),
                        isiPhone: $(i),
                        isTablet: $(s),
    ...
    function za(r, e) {
        ...
        var n = r.selection.getRng(), o = yt.fromDom(n.startContainer), i = yt.fromDom(r.getBody()),
            a = e.fold(function () {
                return "." + nu()
            }, function (e) {
                return "[" + ru() + '="' + e + '"]'
    ...
    function Np(T, A) {
        ...
        return function (e, g) {
            ...
            g.remove_trailing_brs && e.addNodeFilter("br", function (e, t, n) {
                var r, o, i, a, u, s, c, l, f = e.length, d = Mn.extend({}, p.getBlockElements()),
    ...
    function Qp(e, t) {
        var n = function (e) {
            ...
            var i = Si(r.pageYOffset, o.scrollTop), a = Si(r.pageXOffset, o.scrollLeft),
                u = Si(o.clientTop, n.clientTop), s = Si(o.clientLeft, n.clientLeft);
    ...
    function Vw(e) {
        e.contentCSS = e.contentCSS.concat(function (t) {
            var e = Lf(t), n = t.editorManager.baseURL + "/skins/content",
    ...
    var mx = d(ob, Uu.isAbove, -1), gx = d(ob, Uu.isBelow, 1), px = d(ib, -1, mx), vx = d(ib, 1, gx),
        ...
        Px = function (e, t) {
            ...
            return function (e, t) {
                ...
                var r = t ? Ms.Forwards : Ms.Backwards, o = rc(e.getBody()), i = d(Ts, o.next), a = d(Ts, o.prev),
                    u = t ? i : a, s = t ? Ph : Lh, c = Ss(r, e.getBody(), n), l = Ky.normalizePosition(t, u(c));
            ...
            if (e.selection.isCollapsed() && RC(e)) {
                var r = e.dom, o = e.selection.getRng(), i = Ds.fromRangeStart(o),
    ...
    var yE = Xi.DOM, bE = Mn.extend, CE = Mn.each, wE = Mn.resolve, xE = Nn.ie,
